...
class OptimizerCriticalCss {
    ...
    public static function generateCriticalCSS($data) {
        ...
        do_action('two_after_generate_critical_css', debug_backtrace()); //phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_debug_backtrace
    ...
    public static function createCriticalCSS($file_path, $firstImportOfCss = false, $file_content = '', $css_import_no_rest = false) {
        ...
        if (!empty($file_content) || (file_exists($file_path) && is_readable($file_path))) {
            try {
                ...
                do_action('two_after_create_critical_css', debug_backtrace()); //phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_debug_backtrace
